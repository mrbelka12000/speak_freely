...
import (
	...
	billinginfoservice "github.com/mrbelka12000/speak_freely/internal/service/billing_info"
...
type Service struct {
	...
	BillingInfo *billinginfoservice.Service
}
...
func New(r *repository.Repo) *Service {
	return &Service{
		...
		BillingInfo: billinginfoservice.New(r.BillingInfo),
	}
}
